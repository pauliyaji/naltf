...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth', '2fa', 'admin']], function () {
    ...
    Route::post('resources/parse-csv-import', 'ResourceController@parseCsvImport')->name('resources.parseCsvImport');
    Route::post('resources/process-csv-import', 'ResourceController@processCsvImport')->name('resources.processCsvImport');
