    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.resources.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('authors') ? 'is-invalid' : '' }}" type="text" name="authors" id="authors" value="{{ old('authors', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('authors_affiliation') ? 'is-invalid' : '' }}" type="text" name="authors_affiliation" id="authors_affiliation" value="{{ old('authors_affiliation', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_of_publication') ? 'is-invalid' : '' }}" type="text" name="date_of_publication" id="date_of_publication" value="{{ old('date_of_publication') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('year_of_publication') ? 'is-invalid' : '' }}" type="text" name="year_of_publication" id="year_of_publication" value="{{ old('year_of_publication', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('issn_isbn_doi') ? 'is-invalid' : '' }}" type="text" name="issn_isbn_doi" id="issn_isbn_doi" value="{{ old('issn_isbn_doi', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('volume') ? 'is-invalid' : '' }}" type="text" name="volume" id="volume" value="{{ old('volume', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('references') ? 'is-invalid' : '' }}" name="references" id="references">{!! old('references') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pages') ? 'is-invalid' : '' }}" type="text" name="pages" id="pages" value="{{ old('pages', '1') }}" required>
                @if($errors->has('pages'))
