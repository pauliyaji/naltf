                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.resources.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="authors_affiliation" id="authors_affiliation" value="{{ old('authors_affiliation', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="date_of_publication" id="date_of_publication" value="{{ old('date_of_publication') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="year_of_publication" id="year_of_publication" value="{{ old('year_of_publication', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="issn_isbn_doi" id="issn_isbn_doi" value="{{ old('issn_isbn_doi', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="abstract" id="abstract">{!! old('abstract') !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="references" id="references">{!! old('references') !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="tags" id="tags" value="{{ old('tags', '') }}" required>
                            @if($errors->has('tags'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('tags') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="pages" id="pages" value="{{ old('pages', '1') }}" required>
                            @if($errors->has('pages'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('pages') }}
                                </div>
